...
return array(
    ...
    */
    ...
    |
    */
    'login_form' =>             'cookbook::pages.auth.login',
    'signup_form' =>            'cookbook::pages.auth.signup',
    'forgot_password_form' =>   'cookbook::pages.auth.forgot_password',
    'reset_password_form' =>    'cookbook::pages.auth.reset_password',
    ...
    */
    ...
    'email_reset_password' =>       'cookbook::emails.passwordreset', // with $user and $token.
    'email_account_confirmation' => 'cookbook::emails.confirm', // with $user
