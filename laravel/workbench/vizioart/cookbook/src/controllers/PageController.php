 ...
 * 
 */
class PageController extends AdminPageBaseController {

	public function index(){

		$this->renderPage(array(
			"content_view" => 'cookbook::pages.page.index'
		));
		...
		$footer_data['scripts'] = array(
			array(
				...
				'attrs' => array(
					'data-main' => asset('packages/vizioart/cookbook/js/app/pages/ps-pages-main.js')
				),
			)
		);
	...
	public function add(){
		...
		$footer_data['scripts'] = array(
			array(
				'src' => asset('packages/vizioart/cookbook/js/lib/require.min.js'),
				'attrs' => array(
					'data-main' => asset('packages/vizioart/cookbook/js/app/page/ps-page-main.js')
				),
			)
		);

		$this->renderPage(array(
			"content_view" => 'cookbook::pages.page.edit',
	...
	public function edit($id = false){
		...
		$content_data = array();
		if (!empty($id)){
			$model = Post::where('type', 'page')->find($id);
			if ($model){
