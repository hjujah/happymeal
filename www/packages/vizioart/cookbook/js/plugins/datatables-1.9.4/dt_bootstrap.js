(function (factory) {
	...
	$.extend( true, $.fn.dataTable.defaults, {
		"sDom": "<'row'<'col-sm-12'<'pull-right'f><'pull-left'l>r<'clearfix'>>><'table-wrapper't><'row'<'col-sm-12'<'pull-left'i><'pull-right'p><'clearfix'>>>",
		...
		"bs_two_button": {
			"fnInit": function ( oSettings, nPaging, fnCallbackDraw )
			{
				...
				var sAppend = '<ul class="pagination">'+
					'<li class="prev"><a class="'+oSettings.oClasses.sPagePrevDisabled+'" tabindex="'+oSettings.iTabIndex+'" role="button" rel="tooltip" data-toggle="tooltip" data-placement="bottom" title="'+oLang.sPrevious+'"><span class="glyphicon glyphicon-chevron-left"></span></a></li>'+
					'<li class="next"><a class="'+oSettings.oClasses.sPageNextDisabled+'" tabindex="'+oSettings.iTabIndex+'" role="button" rel="tooltip" data-toggle="tooltip" data-placement="bottom" title="'+oLang.sNext+'"><span class="glyphicon glyphicon-chevron-right"></span></a></li>'+
					'</ul>';
